function [hf, projection_matrix, res_norms] = train_joint(hf, projection_matrix, xlf, yf, reg_filter, sample_energy, reg_energy, proj_energy, params, init_CG_opts)
...
for iter = 1:params.init_GN_iter
    ...
    [hf, res_norms_temp] = pcg_ccot(...
        @(x) lhs_operation_joint(x, init_samplef_proj, reg_filter, init_samplef, init_samplef_H, init_hf, params.projection_reg),...
